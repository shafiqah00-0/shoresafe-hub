...
// Use a specific query to get only pending users (Authorities & Stakeholders)
...
<head>
    ...
    <style>
        ...
        .active-tab { background: #3182ce !important; color: #fff !important; border-color: #3182ce !important; }
    </style>
</head>
<body>
    ...
    <!-- Pending Registrations Modal (Updated Options) -->
    <div id="approval-modal" class="modal-overlay">
        <div class="modal-card" style="width: 80%; max-width: 650px;">
            ...
            <div style="padding: 0 20px 10px;">
                <div class="pending-tabs" style="display: flex; gap: 10px; border-bottom: 1px solid #4a5568; padding-bottom: 10px;">
                    <button id="tab-all" class="tab-btn active-tab" onclick="loadPendingUsers('all')">All</button>
                    <button id="tab-authorities" class="tab-btn" onclick="loadPendingUsers('authorities')">Authorities</button>
                    <button id="tab-stakeholders" class="tab-btn" onclick="loadPendingUsers('stakeholders')">Stakeholders</button>
                </div>
            </div>
    ...
    <!-- User Details Sub-Modal -->
    <div id="user-detail-modal" class="modal-overlay" style="display: none; z-index: 1100;">
        <div class="modal-card" style="width: 90%; max-width: 480px; background: #1a202c; color: #fff;">
            <div class="modal-header" style="border-bottom: 1px solid #2d3748; padding-bottom: 10px;">
                <h3 style="margin: 0; color: #63b3ed;"><i class="fas fa-id-card"></i> User Registration Details</h3>
                <button class="close-modal" onclick="closeUserDetailModal()" style="color: #a0aec0;">&times;</button>
            </div>
            <div class="modal-body" style="padding-top: 15px;">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; font-size: 0.95rem;">
                    <div>
                        <strong style="color: #a0aec0; display: block; font-size: 0.8rem;">FULL NAME</strong>
                        <span id="detail-name" style="font-weight: 600;">-</span>
                    </div>
                    <div>
                        <strong style="color: #a0aec0; display: block; font-size: 0.8rem;">ROLE TYPE</strong>
                        <span id="detail-role" style="color: #63b3ed;">-</span>
                    </div>
                    <div>
                        <strong style="color: #a0aec0; display: block; font-size: 0.8rem;">REGISTRATION #</strong>
                        <span id="detail-reg">-</span>
                    </div>
                    <div>
                        <strong style="color: #a0aec0; display: block; font-size: 0.8rem;">EMAIL</strong>
                        <span id="detail-email">-</span>
                    </div>
                </div>
                <div style="margin-top: 20px; text-align: right; border-top: 1px solid #2d3748; padding-top: 12px;">
                    <button type="button" id="detail-approve-btn" class="btn-approve-user" 
                            style="background: #48bb78; color: white; border: none; padding: 8px 16px; cursor: pointer; border-radius: 4px; font-weight: 600;">
                        Approve User
                    </button>
                </div>
            </div>
